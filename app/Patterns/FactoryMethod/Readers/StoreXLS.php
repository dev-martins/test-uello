...
class StoreXLS implements SpreadsheetInterface, ToModel, WithHeadingRow, WithBatchInserts, WithChunkReading
{
    ...
    {
        Excel::import($this, base_path('storage/app/public/csv/' . $this->data['file']));
    }
